...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        for last_a_node in self.a_levels[level - 1]:
            for state_node in last_a_node.effnodes:
                state_node.parents.add(last_a_node)
                last_a_node.children.add(state_node)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        #check if the sets of the positive and negative effects of the two actions intersect
        check1 = bool(set(action1.effect_add) & set(action2.effect_rem))
        check2 = bool(set(action2.effect_add) & set(action1.effect_rem))


        # print("act1 eff + : ", action1.effect_add)
        # print("act2 eff - : ", action2.effect_rem)
        # print(check1)
        #
        # print("act2 eff + : ", action2.effect_add)
        # print("act1 eff - : ", action1.effect_rem)
        # print(check2)
        # print("-----------------------------------")
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        #check weather the effect and precondition of action1 or action2 negate each other
        #by checking if set intersects each other
        check1 = bool(set(action1.effect_add) & set(action2.precond_neg))
        check2 = bool(set(action1.effect_rem) & set(action2.precond_pos))
        check3 = bool(set(action2.effect_add) & set(action1.precond_neg))
        check4 = bool(set(action2.effect_rem) & set(action1.precond_pos))
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        #check if the of the check if the state nodes of of two actions are mutex
        parents1 = node_a1.parents
        parents2 = node_a2.parents

        for state1 in parents1:
            for state2 in parents2:
                if state1.is_mutex(state2):
                    return True
        return False
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        check1 = node_s1.symbol == node_s2.symbol
        check2 = node_s1.is_pos != node_s2.is_pos
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        actions1 = node_s1.parents
        actions2 = node_s2.parents
